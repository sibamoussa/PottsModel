       ...
       % seq=train_energy_table(min_idx,1);
        ...
        for i=1:400:(size_table-97)
           ...
           %  writecell(u_list,"partialEE_original/energies_"+ int2str(i) + ".xls",'Sheet',1,'Range','A1')
             writecell(e_diff_accepted,"partialEE_original/energies_"+ int2str(i) + ".xlsx",'Sheet',1,'Range','B1');
             writecell(e_diff_rejected,"partialEE_original/energies_"+ int2str(i) + ".xlsx",'Sheet',1,'Range','C1');
...
%           u(any(u==0, 2))=[];
%           e_diff_accepted(any(e_diff_accepted==0, 2))=[];
%           e_diff_rejected(any(e_diff_rejected==0, 2))=[];
